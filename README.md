...
| [`sheets/candidate-profile.md`](sheets/candidate-profile.md) | Candidate Profile tab: picker plus spider chart of requirement vs self-ratings |
...
| [`docs/looker-visual-guide.html`](docs/looker-visual-guide.html) | Illustrated Looker Studio setup (download and open in a browser) |
